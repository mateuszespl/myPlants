  ...
  return (
    <StyledStoresSlide>
      ...
      <div>
        <img
          alt="storePic"
          src="https://images.pexels.com/photos/5337385/pexels-photo-5337385.jpeg?auto=compress&cs=tinysrgb&dpr=2&w=500"
        />
        <h2>Łódź</h2>
        <p>Robocza 15F</p>
        <p>Open: 9 - 17</p>
      ...
      <div>
        <img
          alt="storePic"
          src="https://images.pexels.com/photos/4466544/pexels-photo-4466544.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260"
        />
        <h2>Warszawa</h2>
